...
@Component({
	selector: 'app-public-geographic-statistical-code',
	standalone: true,
	imports: [CommonModule, FormsModule, PrimeNgModules],
	templateUrl: './public-geographic-statistical-code.component.html',
	styleUrls: ['./public-geographic-statistical-code.component.scss'],
	providers: [MessageService],
})
export class PublicGeographicStatisticalCodeComponent

...
import { AdminTwoSazsEaUploadComponent } from './master-data/admin-two-sazs-ea-upload/admin-two-sazs-ea-upload.component';
		...
		children: [
			...
			//Mater data managmenet
			{
				...
				children: [
					...
					{
						path: 'two-sazs-ea-upload',
						component: AdminTwoSazsEaUploadComponent,
					},
				],
			},
			{

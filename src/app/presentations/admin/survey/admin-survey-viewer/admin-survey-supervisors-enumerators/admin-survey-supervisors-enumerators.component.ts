...
@Component({
	selector: 'app-admin-survey-supervisors-enumerators',
	templateUrl: './admin-survey-supervisors-enumerators.component.html',
	styleUrls: ['./admin-survey-supervisors-enumerators.component.css'],
	standalone: true,
	imports: [CommonModule, FormsModule, PrimeNgModules],
	providers: [MessageService, ConfirmationService],
})
export class AdminSurveySupervisorsEnumeratorsComponent implements OnInit {
...
Karma Tshering,11703005678,,,`;
	...
	getDzongkhagNames(supervisor: any): string {
		...
		return supervisor.dzongkhags.map((d: any) => d.name).join(', ');
	}
